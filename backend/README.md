...
## Project Structure
    ...
    ├── ideapros_llc_synvio_31951  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_synvio_31951`
...
2. Clone this repo and `cd ideapros_llc_synvio_31951`
